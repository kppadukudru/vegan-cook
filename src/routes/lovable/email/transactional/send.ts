...
const SITE_NAME = "veg-kitchen-buddy"
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Only admins may enqueue transactional email. Without this check any
        // signed-up user could relay arbitrary content from our sending domain.
