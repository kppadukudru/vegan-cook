...
type State = "checking" | "ready" | "already" | "invalid" | "sending" | "done" | "error";
  ...
  return (
    <div className="min-h-screen bg-paper text-ink flex flex-col">
      ...
      <main className="flex-1 px-6 md:px-8 py-20 max-w-[640px] mx-auto w-full space-y-6">
        ...
        {state === "invalid" && (
          <p className="text-sm text-mute">
            This unsubscribe link isn't valid any more. Use the link in the most recent email, or
            reply to it and we'll remove you by hand.
          </p>
        )}
